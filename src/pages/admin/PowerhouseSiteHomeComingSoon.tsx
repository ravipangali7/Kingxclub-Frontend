...
export default function PowerhouseSiteHomeComingSoon() {
  const { value, setValue, save, isLoading, isSaving } = useSiteSettingFieldJson("site_coming_soon_json");
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-6 pb-10">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">Coming soon games section on the home page.</p>
      </div>
      <Card>
