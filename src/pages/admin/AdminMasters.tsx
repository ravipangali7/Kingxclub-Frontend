          ...
          <div className="overflow-y-auto max-h-[70vh] px-1 pb-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <PasswordInput placeholder="Password" value={createPassword} onChange={(e) => setCreatePassword(e.target.value)} />
              </div>
              <div>
      ...
      <Dialog open={resetPwOpen} onOpenChange={setResetPwOpen}>
        <DialogContent className="max-w-xs">
          ...
          <div className="space-y-3">
            ...
            <PasswordInput placeholder="Confirm Password" value={newPasswordConfirm} onChange={(e) => setNewPasswordConfirm(e.target.value)} />
          </div>
          <DialogFooter>
