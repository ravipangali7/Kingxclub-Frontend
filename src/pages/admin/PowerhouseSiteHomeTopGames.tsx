...
export default function PowerhouseSiteHomeTopGames() {
  const { value, setValue, save, isLoading, isSaving } = useSiteSettingFieldJson("site_top_games_json");
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-6 pb-10">
      <div className="flex flex-col gap-1">
        ...
        <h1 className="font-display font-bold text-2xl tracking-tight">Home Top Games</h1>
        <p className="text-sm text-muted-foreground">Top games shown as big cards on the home page.</p>
      </div>
      <Card>
